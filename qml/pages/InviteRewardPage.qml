...
ScrollView {
    ...
    Rectangle {
        ...
        Text {
            ...
            text: qsTr("Number of Invitees: ")
        }
        Text {
            anchors.verticalCenter: invNumText.verticalCenter
            anchors.right: parent.right
            anchors.rightMargin: 250
            text: qsTr("Invitation Rewards: ")
        }
    }
    ...
    Rectangle {
        ...
        RowLayout {
            ...
            Column {
                ...
                Text {
                    text: qsTr("Send an invite link to a friend")
            ...
            Column {
                ...
                Text {
                    text: qsTr("Friends verified by mobile phone number")
            ...
            Column {
                ...
                Text {
                    text: qsTr("The other party receives corresponding rewards")
