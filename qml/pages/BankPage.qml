...
PyPayPage {
    ...
    Rectangle {
        ...
        Text {
            id: totalText
            text: qsTr("Total deposit amount ($)")
            anchors.top: parent.top
        ...
        Text {
            id: borrowText
            text: qsTr("Total amount available for borrowing ($)")
            color: "#FFFFFF"
            font.pointSize: 12
        ...
        Row {
            ...
            Text {
                ...
                text: qsTr("Yesterday's earnings ")
                color: "#FB8F0B"
                font.pointSize: 12
                verticalAlignment: Text.AlignVCenter
            }
